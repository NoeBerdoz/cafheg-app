...
import ch.hearc.cafheg.business.allocations.DroitsAllocations;
...
public class RESTController {
  ...
  public String getParentDroitAllocation(@RequestBody DroitsAllocations droitsAllocations) {
    return inTransaction(() -> allocationService.getParentDroitAllocation(droitsAllocations));
  }
