...
import ch.hearc.cafheg.business.allocations.ParentsInfo;
...
public class RESTController {
  ...
  public String getParentDroitAllocation(@RequestBody ParentsInfo info) {
    return inTransaction(() -> allocationService.getParentDroitAllocation(info));
  }
